...
export default function Contact() {
  ...
  return (
    <section
      ...
      style={{ zIndex: 2 }}
    >
      <div ref={contentRef} className="max-w-7xl mx-auto px-6 lg:px-12" style={{ opacity: 0 }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div>
                <span className="text-white/30 text-xs tracking-[0.2em] uppercase block mb-2">
                  Email
                </span>
                <a
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="text-white/30 text-xs tracking-[0.2em] uppercase block mb-3">
                      Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-transparent border-b border-white/20 pb-3 text-white focus:outline-none focus:border-[#FFB800] transition-colors placeholder:text-white/20"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-transparent border-b border-white/20 pb-3 text-white focus:outline-none focus:border-[#FFB800] transition-colors appearance-none cursor-pointer"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent border-b border-white/20 pb-3 text-white focus:outline-none focus:border-[#FFB800] transition-colors resize-none placeholder:text-white/20"
                ...
                <button
                  type="submit"
                  className="group flex items-center gap-4 px-10 py-5 bg-[#FFB800] text-black text-xs font-semibold tracking-[0.2em] uppercase hover:bg-white transition-colors duration-500 mt-8"
                >
                  Submit Inquiry
                  <svg
